                        ...
                        <div className='flex w-6/12 gap-x-4 items-center'>
                            ...
                            {user?.name && user.role &&
                                <>
                                    ...
                                    {(years && years?.length > 0) && <button onClick={() => setAddNewUser(true)} className='p-3 bg-green-800 text-white rounded-lg w-fit flex items-center flex-row-reverse justify-between'><TbPlus className='size-7' /> أضف شخص جديدة</button>}
                                </>
                            }
                        </div>
                        {
